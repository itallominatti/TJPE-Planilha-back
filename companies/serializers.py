...
from accounts.models import User, User_Groups, Group_Permissions, Group
...
class TaskSerializer(serializers.ModelSerializer):
    ...
    def get_employee(self, obj) -> dict:
    ...
    def update(self, instance, validated_data):
        ...
        instance.employee_id = validated_data.get('employee_id', instance.employee)
